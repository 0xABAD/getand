...
// Place all project dependencies here:
var dependencies = [...]Dep{
	// The minimum information required is the repository name
	// Dep{Repo: "github.com/gorilla/websocket"},

	// However, you can specify a certain branch:
	// Dep{Repo: "github.com/gorilla/websocket", Branch: "v1.2.0"},
}

// Dep specifies a dependency.  At a minimum you only need a repo
// name but there are plenty of other fields to customize.  Note,
// that a dependency doesn't have to be a go package; it can be
// anything.  In fact, hack this script to do exactly what you want
// for your project.
type Dep struct {
